...
firstPoseData = []
fileString = ['+00','+20','+45','+90','-20','-35']

fig = plt.figure(figsize=(10, 10))
for j in range(0,len(fileString)):
    for i in range(1, 38): # 6*6 + 2 (an extra 1 since 14 is missing)
        if i < 10: # 'yaleB0{}' becomes 'yaleB01' when i = 1
            with open('C:/Users/kevin/Documents/Python/AMAT-534Homework3/CroppedYale/yaleB0{}/yaleB0{}_P00A+000E{}.pgm'.format(i,i,fileString[j]), 'rb') as pgmf:
                img = plt.imread(pgmf)
            ...
            with open('C:/Users/kevin/Documents/Python/AMAT-534Homework3/CroppedYale/yaleB{}/yaleB{}_P00A+000E{}.pgm'.format(i,i,fileString[j]), 'rb') as pgmf:
                img = plt.imread(pgmf)
                firstPoseData.append(img) # stores each array in a list
                fig.add_subplot(6,6,i)
                plt.title('{}'.format(i))
